        ...
        <nav class="navbar navbar-expand-lg navbar-dark px-5 py-3 py-lg-0">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a href="/home" class="nav-item nav-link active" class="{{ Request::path() == 'home' ? 'active' : '' }}">Home</a>
                    <a href="/about" class="nav-item nav-link" class="{{ Request::path() == 'about' ? 'active' : '' }}">About</a>
